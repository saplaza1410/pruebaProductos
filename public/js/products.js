$(function() {
		$.fn.dataTable.ext.errMode = 'throw';
	        ...
	        "columns":[
	          ...
	          {data:"size",name:'size', "className": "dt-center"},
	          {data:'observations',name:'observations'},
	          {data:'quantity',name:'quantity', "className": "dt-center"},
	          {data:'date_shipment',name:'date_shipment'},
		...
		$( "#save" ).on( "click", function() {
		  $.ajax({
		    type: "POST",
		    url: "add-products",
		    data: $('form#formproducts').serializeArray(),
		...
		$('#dataTable tbody').on( 'click', 'a.consult', function () {
		    ...
		    $.ajax({
			    ...
			    success: function(result) {
			      ...
			      $("#talla").val(data.size);
			      $("#marca").val(data.brand_id);
			      $("#cantidad").val(data.quantity);
			      $("#fecha_embarque").val(data.date_shipment);
			      $("#observaciones").val(data.observations);
